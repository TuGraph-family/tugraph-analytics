...
export const GraphDefintionEditTable: React.FC<Props> = ({
  ...
  const defaultData = [
    {
      ...
      category: "VERTEX_ID",
      comment: $i18n.get({
        id: "openpiece-geaflow.geaflow.graph-tabs.graphDefintionEditTable.PointId",
        dm: "点ID",
      }),
    },
  ];
  ...
  const categoryType = {
    VERTEX: {
      ...
      PROPERTY: {
        text: $i18n.get({
          id: "openpiece-geaflow.geaflow.graph-tabs.graphDefintionEditTable.VertexProperties",
          dm: "点属性",
        }),
      },
    },

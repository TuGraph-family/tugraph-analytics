...
// @ts-ignore
import { GeaflowPlugManage } from '@@plugins/src/components/console/geaflow';
...
export default React.memo((props) => {
  ...
  const hasCustomBlock = children?.find(
    (d) => d.key === 'GeaflowPlugManage'
  );

  if (!hasCustomBlock) {
    children.push({
      key: 'GeaflowPlugManage',
      type: 'item',
      title: 'GeaflowPlugManage',

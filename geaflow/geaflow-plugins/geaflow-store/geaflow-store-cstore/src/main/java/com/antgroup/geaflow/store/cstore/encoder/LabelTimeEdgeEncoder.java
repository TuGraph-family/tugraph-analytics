...
public class LabelTimeEdgeEncoder extends EdgeEncoder {

    public LabelTimeEdgeEncoder(GraphDataSchema dataSchema) {
        super(dataSchema);
    }
    ...
    public IEdge decode(EdgeContainer container) {
        ...
        return emptyProperty || container.property.length == 0 ? edge :
               edge.withValue(valueDeserializer.apply(container.property));
    }
}

...
public class ValueLabelTimeEdgeArray<K> extends ValueEdgeArray<K> {
    ...
    protected IEdge<K, Object> getEdge(K sid, int pos) {
        return new ValueLabelTimeEdge<>(sid, getDstId(pos), getValue(pos),
            getDirection(pos), labels[pos], times[pos]);
    }

...
public class LocalClusterId implements ClusterId {

    private LocalMasterRunner master;

    public LocalClusterId(LocalMasterRunner master) {
        this.master = master;
    }

    public LocalMasterRunner getMaster() {
        return master;
    }

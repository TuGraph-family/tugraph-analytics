...
public class RaySystemFunc implements Serializable {
    ...
    public static void initRayEnv(ClusterConfig clusterConfig) {
        ...
        systemProperties.put(RayConfig.RAY_JOB_NUM_JAVA_WORKER_PER_PROCESS, String.valueOf(1));
        ...
        // default trigger L1 FO
        boolean enableL1Fo = clusterConfig.isFoEnable();
        systemProperties.put(RayConfig.RAY_JOB_L1FO_ENABLE, String.valueOf(enableL1Fo));
        systemProperties.put(RayConfig.RAY_TASK_RETURN_TASK_EXCEPTION, Boolean.FALSE.toString());

        // allow job long running
        systemProperties.put(RayConfig.RAY_JOB_LONG_RUNNING, Boolean.TRUE.toString());

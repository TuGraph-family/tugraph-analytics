...
package org.apache.geaflow.cluster.ray.context;
...
public class RayContainerContext extends ContainerContext {

    public RayContainerContext(int index, Configuration config) {
        super(index, config);
    }

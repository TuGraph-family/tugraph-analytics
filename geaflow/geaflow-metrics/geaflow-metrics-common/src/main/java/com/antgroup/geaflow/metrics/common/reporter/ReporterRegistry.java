...
public class ReporterRegistry {
    ...
    static {
        register(SLF4J_REPORTER, "com.antgroup.geaflow.metrics.slf4j.Slf4jReporter");
        register(TSDB_REPORTER, "com.antgroup.geaflow.metrics.tsdb.TsdbMetricReporter");
        register(INFLUXDB_REPORTER, "com.antgroup.geaflow.metrics.influxdb.InfluxdbReporter");
    }

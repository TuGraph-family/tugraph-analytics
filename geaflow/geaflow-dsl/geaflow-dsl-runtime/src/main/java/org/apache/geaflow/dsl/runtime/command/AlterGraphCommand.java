...
public class AlterGraphCommand implements IQueryCommand {

    private final SqlAlterGraph alterGraph;

    public AlterGraphCommand(SqlAlterGraph alterGraph) {
        this.alterGraph = alterGraph;
    }

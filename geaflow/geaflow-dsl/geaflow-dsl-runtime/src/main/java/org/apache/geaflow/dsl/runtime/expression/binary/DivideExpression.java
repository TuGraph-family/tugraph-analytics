...
public class DivideExpression extends AbstractReflectCallExpression {

    public static final String METHOD_NAME = "divide";

    public DivideExpression(Expression left, Expression right, IType<?> outputType) {
    ...
    public Expression copy(List<Expression> inputs) {
        ...
        return new DivideExpression(inputs.get(0), inputs.get(1), getOutputType());
    }
}

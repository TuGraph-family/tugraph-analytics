...
public class GTEExpression extends AbstractReflectCallExpression {

    public static final String METHOD_NAME = "greaterThanEq";

    public GTEExpression(Expression left, Expression right) {
    ...
    public Expression copy(List<Expression> inputs) {
        ...
        return new GTEExpression(inputs.get(0), inputs.get(1));
    }
}

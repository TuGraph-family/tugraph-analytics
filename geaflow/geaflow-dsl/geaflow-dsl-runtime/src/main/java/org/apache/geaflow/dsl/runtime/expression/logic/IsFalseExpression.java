...
public class IsFalseExpression extends AbstractNonLeafExpression {

    public IsFalseExpression(Expression input) {
    ...
    public String showExpression() {
        return inputs.get(0).showExpression() + " is false";
    }

    @Override
    public Expression copy(List<Expression> inputs) {
        assert inputs.size() == 1;
        return new IsFalseExpression(inputs.get(0));
    }
}

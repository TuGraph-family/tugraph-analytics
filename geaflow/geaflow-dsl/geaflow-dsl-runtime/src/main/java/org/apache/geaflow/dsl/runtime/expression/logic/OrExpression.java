...
public class OrExpression extends AbstractNonLeafExpression {

    public OrExpression(List<Expression> inputs) {
    ...
    public String showExpression() {
        return "Or(" + inputs.stream().map(Expression::showExpression)

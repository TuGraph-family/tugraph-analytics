...
public class MultiplyExpression extends AbstractReflectCallExpression {

    public static final String METHOD_NAME = "times";

    public MultiplyExpression(Expression left, Expression right, IType<?> outputType) {
    ...
    public Expression copy(List<Expression> inputs) {
        ...
        return new MultiplyExpression(inputs.get(0), inputs.get(1), getOutputType());
    }
}

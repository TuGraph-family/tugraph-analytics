...
public class IsNotFalseExpression extends AbstractNonLeafExpression {

    public IsNotFalseExpression(Expression input) {
    ...
    public String showExpression() {
        return inputs.get(0).showExpression() + " is not false";
    }

    @Override
    public Expression copy(List<Expression> inputs) {
        assert inputs.size() == 1;
        return new IsNotFalseExpression(inputs.get(0));
    }
}

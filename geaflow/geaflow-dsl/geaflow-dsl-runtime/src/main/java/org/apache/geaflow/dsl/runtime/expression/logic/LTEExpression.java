...
public class LTEExpression extends AbstractReflectCallExpression {

    public static final String METHOD_NAME = "lessThanEq";

    public LTEExpression(Expression left, Expression right) {
    ...
    public Expression copy(List<Expression> inputs) {
        ...
        return new LTEExpression(inputs.get(0), inputs.get(1));
    }
}

...
public class StepExchangeOperator extends AbstractStepOperator<StepKeyFunction, StepRecord, StepRecord> {


    public StepExchangeOperator(long id, StepKeyFunction function) {
        super(id, function);
    }
    ...
    public StepOperator<StepRecord, StepRecord> copyInternal() {
        return new StepExchangeOperator(id, function);
    }
}

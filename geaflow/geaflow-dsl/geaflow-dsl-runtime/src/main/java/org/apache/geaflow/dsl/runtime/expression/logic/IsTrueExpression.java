...
public class IsTrueExpression extends AbstractNonLeafExpression {

    public IsTrueExpression(Expression input) {
    ...
    public String showExpression() {
        return inputs.get(0).showExpression() + " is true";
    }

    @Override
    public Expression copy(List<Expression> inputs) {
        assert inputs.size() == 1;
        return new IsTrueExpression(inputs.get(0));
    }
}

...
public class IsNotTrueExpression extends AbstractNonLeafExpression {

    public IsNotTrueExpression(Expression input) {
    ...
    public String showExpression() {
        return inputs.get(0).showExpression() + " is not true";
    }

    @Override
    public Expression copy(List<Expression> inputs) {
        assert inputs.size() == 1;
        return new IsNotTrueExpression(inputs.get(0));
    }
}

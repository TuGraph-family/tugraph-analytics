...
public class EqualExpression extends AbstractReflectCallExpression {

    public static final String METHOD_NAME = "equal";
    ...
    public Expression copy(List<Expression> inputs) {
        ...
        return new EqualExpression(inputs.get(0), inputs.get(1));
    }
}

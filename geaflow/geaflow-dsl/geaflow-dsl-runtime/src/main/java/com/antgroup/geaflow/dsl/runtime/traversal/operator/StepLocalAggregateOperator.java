...
public class StepLocalAggregateOperator extends AbstractStepOperator<StepAggregateFunction, Row, Row> {

    private Map<ParameterRequest, Object> requestId2Accumulators;

    public StepLocalAggregateOperator(long id, StepAggregateFunction function) {
        super(id, function);
    }
    ...
    public StepOperator<Row, Row> copyInternal() {
        return new StepLocalAggregateOperator(id, function);
    }
}

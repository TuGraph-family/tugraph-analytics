CREATE TABLE IF NOT EXISTS join_to_match_006_result (
	studentId1 bigint,
	studentName varchar,
	studentAge bigint,
  teacherId1 bigint,
...
INSERT INTO join_to_match_006_result
SELECT studentId1, studentName, studentAge, teacherId1, teacherName
FROM
(

...
public class OdpsTableConnector implements TableReadableConnector, TableWritableConnector {

    public static final String TYPE = "ODPS";
    ...
    public TableSource createSource(Configuration conf) {
        return new OdpsTableSource();
    }

    @Override
    public TableSink createSink(Configuration conf) {
        return new OdpsTableSink();
    }
}

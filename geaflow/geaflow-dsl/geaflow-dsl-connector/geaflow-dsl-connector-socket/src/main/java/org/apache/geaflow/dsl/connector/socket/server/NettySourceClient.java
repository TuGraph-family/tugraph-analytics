...
public class NettySourceClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(NettySourceClient.class.getName());
    ...
    public NettySourceClient(String host, int port, LinkedBlockingQueue<String> dataQueue) {
        this.host = host;
        this.port = port;
    ...
    private class ClientHandler extends ChannelInboundHandlerAdapter {
        ...
        public void channelActive(ChannelHandlerContext ctx) throws Exception {
            String getDataMsg = NettyWebServer.CMD_GET_DATA + "\n";
            ctx.writeAndFlush(getDataMsg);
        }

        @Override
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            String data = String.valueOf(msg);
            LOGGER.info("source get data: {}", msg);
            dataQueue.put(data);
        }
    }
}

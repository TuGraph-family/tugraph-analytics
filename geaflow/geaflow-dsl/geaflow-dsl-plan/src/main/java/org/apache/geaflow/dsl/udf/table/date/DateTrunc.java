...
@Description(name = "date_trunc", description = "Returns date truncated to the unit specified by "
    + "the format.")
public class DateTrunc extends UDF {
    ...
    public String eval(String date, String datepart) {
        ...
        switch (datepart.toLowerCase()) {
            case "yyyy":
            case "year":
                return String.format(DATE_FORMAT, calendar.get(Calendar.YEAR), 1, 1, 0, 0, 0);
            case "mm":
            case "mon":
            case "month":
            ...
            case "day":
                return String.format(DATE_FORMAT, calendar.get(Calendar.YEAR),
                    calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
            case "hh":
            case "hour":
                return String.format(DATE_FORMAT, calendar.get(Calendar.YEAR),

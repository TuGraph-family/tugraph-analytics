...
import com.antgroup.geaflow.dsl.udf.table.agg.MaxLong.Accumulator;
import java.io.Serializable;

@Description(name = "max", description = "The max function for bigint.")
public class MaxLong extends UDAF<Long, Accumulator, Long> {
    @Override

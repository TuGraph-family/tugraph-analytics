...
import com.antgroup.geaflow.dsl.udf.table.agg.Count.Accumulator;
import java.io.Serializable;

@Description(name = "count", description = "The count function.")
public class Count extends UDAF<Object, Accumulator, Long> {
    ...
    @Override
    public void accumulate(Accumulator accumulator, Object input) {
        if (input != null) {
            accumulator.value++;
        }
    }

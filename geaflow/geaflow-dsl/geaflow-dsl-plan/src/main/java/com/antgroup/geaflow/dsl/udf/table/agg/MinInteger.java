...
import com.antgroup.geaflow.dsl.udf.table.agg.MinInteger.Accumulator;
import java.io.Serializable;

@Description(name = "min", description = "The min function for int.")
public class MinInteger extends UDAF<Integer, Accumulator, Integer> {
    @Override

...
import com.antgroup.geaflow.dsl.udf.table.agg.MinDouble.Accumulator;
import java.io.Serializable;

@Description(name = "min", description = "The min function for double.")
public class MinDouble extends UDAF<Double, Accumulator, Double> {
    @Override

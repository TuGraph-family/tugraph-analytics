...
import static com.antgroup.geaflow.analytics.service.client.jdbc.property.ConnectProperties.CUSTOM_HEADERS;
import static com.antgroup.geaflow.analytics.service.client.jdbc.property.ConnectProperties.SESSION_PROPERTIES;
...
public final class AnalyticsDriverUri {
    ...
    private AnalyticsDriverUri(URI uri, Properties driverProperties) {
        ...
        useSecureConnection = uri.getPort() == JDBC_SECURE_PORT;
        initGraphView();
    }
    ...
    private static boolean acceptsURL(String url) {
        if (url.startsWith(DRIVER_URL_START)) {
            return true;
        }
        throw new GeaflowRuntimeException("Invalid GeaFlow URL Prefix: " + url);
    }

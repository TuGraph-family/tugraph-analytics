...
public class ClientHandlerFactory {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ClientHandlerFactory.class);

    public static IQueryRunner loadClientHandler(ClientHandlerContext handlerContext) {

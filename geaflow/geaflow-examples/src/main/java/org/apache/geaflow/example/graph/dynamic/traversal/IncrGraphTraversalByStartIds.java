...
public class IncrGraphTraversalByStartIds {

    private static final Logger LOGGER = LoggerFactory.getLogger(IncrGraphTraversalByStartIds.class);

    public static final String RESULT_FILE_PATH = "./target/tmp/data/result/incr_graph_traversal";

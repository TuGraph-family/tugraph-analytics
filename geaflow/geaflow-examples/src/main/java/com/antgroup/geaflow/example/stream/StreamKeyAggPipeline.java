...
public class StreamKeyAggPipeline implements Serializable {

    private static final Logger LOGGER = LoggerFactory.getLogger(StreamKeyAggPipeline.class);

    public static final String RESULT_FILE_PATH = "./target/tmp/data/result/agg2";
    public static final String REF_FILE_PATH = "data/reference/agg2";

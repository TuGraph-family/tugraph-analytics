...
import com.antgroup.geaflow.example.graph.dynamic.traversal.IncrGraphTraversalAll;
...
public class IncGraphTraversalAllTest extends BaseTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(IncGraphTraversalAllTest.class);
    ...
    public void test1ShardWithSingleConcurrency() throws Exception {
        ...
        IncrGraphTraversalAll pipeline = new IncrGraphTraversalAll();

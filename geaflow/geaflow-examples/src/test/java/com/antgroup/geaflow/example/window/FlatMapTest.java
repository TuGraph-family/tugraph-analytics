...
import com.antgroup.geaflow.example.stream.StreamWordFlatMapPipeline;
...
public class FlatMapTest extends BaseTest {
    ...
    private static final Logger LOGGER =
        LoggerFactory.getLogger(FlatMapTest.class);
    ...
    public void test() throws Exception {
        ...
        StreamWordFlatMapPipeline pipeline = new StreamWordFlatMapPipeline();

...
import com.antgroup.geaflow.example.graph.dynamic.traversal.IncrGraphTraversalByStream;
...
public class IncGraphTraversalByStreamTest extends BaseTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(IncGraphTraversalByStreamTest.class);

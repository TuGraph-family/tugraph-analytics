...
public class WindowAggOperatorTest {

    private static int batchSize = 10;

    private WindowAggregateOperator operator;
    private MyAgg agg;
    ...
    public void setup() {
        ...
        this.agg = new MyAgg();
        this.operator = new WindowAggregateOperator<>(this.agg, new KeySelectorFunc());
    ...
    public void testAgg() throws Exception {
        ...
        batchId = 1;
        for (int i = 0; i < 1000; i++) {
            this.operator.processValue((long) i);
            if ((i + 1) % batchSize == 0) {

...
public class ComputeIncGraph<K, VV, EV, M> extends AbstractGraphView<K, VV, EV, M,
    ...
    public PWindowStream<IVertex<K, VV>> computeOnIncVertexCentric(IncVertexCentricCompute<K, VV,
        EV, M> incVertexCentricCompute) {
        processOnVertexCentric(incVertexCentricCompute);
        IGraphVertexCentricOp<K, VV, EV, M> graphVertexCentricComputeOp = new DynamicGraphVertexCentricComputeOp(graphViewDesc, incVertexCentricCompute);

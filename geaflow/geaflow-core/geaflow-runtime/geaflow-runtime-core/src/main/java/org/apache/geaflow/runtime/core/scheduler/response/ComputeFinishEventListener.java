...
public class ComputeFinishEventListener extends AbstractFixedSizeEventHandler {

    public ComputeFinishEventListener(int eventCount, IEventCompletedHandler handler) {
        super(eventCount, handler);
    }

    @Override
    ResponseEventCache buildEventCache() {
        return new EventCache(expectedSize);
    }

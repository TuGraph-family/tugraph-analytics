...
/**
 * Defined creating of the task.
 */
public class CreateTaskEvent implements ICommand, IHighAvailableEvent {

    private int workerId;
    private HighAvailableLevel haLevel;

    public CreateTaskEvent(int workerId, HighAvailableLevel haLevel) {

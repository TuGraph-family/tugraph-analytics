...
package org.apache.geaflow.api.pdata.stream.view;
...
public interface PIncStreamView<T> extends PStreamView<T> {

    /**
     * Incremental reduce compute.
     */
    PWindowStream<T> reduce(ReduceFunction<T> reduceFunction);

    /**
     * Incremental aggregate compute.
     */

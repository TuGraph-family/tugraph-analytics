...
/**
 * Interface for static vertex centric traversal function with graph aggregation.
 ...
 */
public interface VertexCentricAggTraversalFunction<K, VV, EV, M, R, I, GR>
    extends VertexCentricTraversalFunction<K, VV, EV, M, R>, VertexCentricAggContextFunction<I, GR> {
}

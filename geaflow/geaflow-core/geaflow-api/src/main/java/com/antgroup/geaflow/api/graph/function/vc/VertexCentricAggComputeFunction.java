...
/**
 * Interface for static vertex centric compute function with graph aggregation.
 ...
 */
public interface VertexCentricAggComputeFunction<K, VV, EV, M, I, GR>
    extends VertexCentricComputeFunction<K, VV, EV, M>, VertexCentricAggContextFunction<I, GR> {

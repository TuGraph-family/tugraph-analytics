...
package org.apache.geaflow.shuffle.util;

/**
 * refer to the implementation of flink.
 */
public class AtomicReferenceCounter {
    ...
    public AtomicReferenceCounter(int disposeOnReferenceCount) {
     ...
     *
     * <p>If the method returns <code>false</code>, the counter has already been disposed.

...
public class MetricServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest,
      com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse> METHOD_QUERY_METRICS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "MetricService", "queryMetrics"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse.getDefaultInstance()));
  ...
  /**
   */
  @java.lang.Deprecated public static interface MetricService {

    /**
     */
    public void queryMetrics(com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest request,
        io.grpc.stub.StreamObserver<com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse> responseObserver);
  }
  ...
  /**
   */
  @java.lang.Deprecated public static interface MetricServiceBlockingClient {

    /**
     */
    public com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse queryMetrics(com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest request);
  }

  /**
   */
  @java.lang.Deprecated public static interface MetricServiceFutureClient {

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse> queryMetrics(
        com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest request);
  }
  ...
  @java.lang.Deprecated public static abstract class AbstractMetricService extends MetricServiceImplBase {}
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QUERY_METRICS:
          serviceImpl.queryMetrics((com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest) request,
              (io.grpc.stub.StreamObserver<com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse>) responseObserver);
          break;
        default:
  ...
  @java.lang.Deprecated public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          asyncUnaryCall(
            new MethodHandlers<
              com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryRequest,
              com.antgroup.geaflow.rpc.proto.Metrics.MetricQueryResponse>(

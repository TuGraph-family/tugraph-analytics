...
进入图研发页面，console在启动后会自动创建出一个demo作业。(quickStart中的环路查找作业)

![create_job](../../../static/img/demo_job.png)

![add_dsl_job](../../../static/img/demo_job_detail.png)
可点击发布按钮，直接发布作业。

![add_dsl_job](../../../static/img/release_job.png)

...
public abstract class GeaflowBuildStage {

    public abstract void init(GeaflowRelease release);

    public abstract boolean update(GeaflowRelease release, ReleaseUpdate update);

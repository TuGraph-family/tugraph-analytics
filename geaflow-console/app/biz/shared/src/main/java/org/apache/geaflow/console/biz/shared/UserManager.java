...
public interface UserManager extends NameManager<UserView, UserSearch> {

    String register(UserView view);

    UserView getUser(String userId);

    String addUser(UserView view);

    boolean updateUser(String userId, UserView view);

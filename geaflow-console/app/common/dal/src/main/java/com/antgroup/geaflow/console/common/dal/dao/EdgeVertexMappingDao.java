...
@Repository
public class EdgeVertexMappingDao extends TenantLevelDao<EdgeVertexMappingMapper, EdgeVertexMappingEntity> implements
    IdDao<EdgeVertexMappingEntity, IdSearch> {

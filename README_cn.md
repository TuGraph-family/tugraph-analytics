...
[![total_time](docs/static/img/vs_join_total_time_cn.jpg)](docs/docs-cn/source/8.principle/vs_join.md)

[为什么使用图进行关联运算比表Join更具吸引力？](docs/docs-cn/source/8.principle/vs_join.md)

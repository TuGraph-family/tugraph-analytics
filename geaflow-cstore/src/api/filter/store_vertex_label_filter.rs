...
pub struct StoreVertexLabelFilter {
    expected_labels: Vec<u16>,
}

impl StoreVertexLabelFilter {
    pub fn new(vertex_labels: Vec<u16>) -> Self {
        StoreVertexLabelFilter {
            expected_labels: vertex_labels,
        }
    }
}

impl IFilter for StoreVertexLabelFilter {
